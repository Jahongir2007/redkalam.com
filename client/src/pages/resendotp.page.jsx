...
export default function ResendOtpVerificationPage() {
    ...
    useEffect(() => {
        const resendOtp = async () => {
            try {
                ...
                if (data?.message === "Successfully resent" && data?.data?.success) {
                    setOtpResent(true);
                }
            } catch (err) {
                console.log("Error occurred while resendOtp()", err);
            }
        };
        ...
        <div className="min-h-screen flex flex-col bg-white text-gray-900">
            ...
            <div className="flex items-center justify-center px-6 py-20">
                ...
                >
                    ...
                    {otpResent && (
                        <div className="text-green-700 text-center">Otp code resent</div>
                    )}
